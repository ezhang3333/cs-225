...
int main(int argc, char** argv)
{
    ...
    /* Part 3 Example Run*/
    char tmp{ static_cast<char>(0b11100101) };
    char tmp2{ static_cast<char>(0b10100101) };
    char tmp3{ static_cast<char>(0b11110111) };
    char tmp4{ static_cast<char>(0b00000001) };
    char tmp5{ static_cast<char>(0b11000000) };
