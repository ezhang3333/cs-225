  ...
  */
  ...
  public:
    ...
    */
    ...
    public:
      Iterator();
      Iterator(PNG &png, double tolerance, TraversalFunctions &functions, const Point& startPoint);
    ...
    */
    ImageTraversal(const PNG & png, const Point & start, double tolerance, TraversalFunctions functions);
